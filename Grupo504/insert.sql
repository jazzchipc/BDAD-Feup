...
INSERT INTO Pessoa(idPessoa, nome, idade, sexo, morada, NIF) VALUES (3, 'José Aleixo', 19, 'Masculino', 'Mortosa', 345678912);
...
/*Pessoas -- Funcionários -- Médicos*/

INSERT INTO Pessoa(idPessoa, nome, idade, sexo, NIF) VALUES (26, 'Duque', 42, 'Masculino', 121212121);
INSERT INTO Pessoa(idPessoa, nome, idade, sexo, NIF) VALUES (27, 'Fábio', 28, 'Masculino', 131313131);
...
INSERT INTO Pessoa(idPessoa, nome, idade, sexo, morada, NIF) VALUES (30, 'Veronica', 31, 'Feminino', 'Fão', 161616161);
...
/*Relações entre Utente e Alergia, Utente e Vacina*/
